            ...
            <div className="max-w-md w-full   bg-white/20 rounded-lg shadow-2xl border border-white/30">
                <div className="p-6">
                    <div className="w-full justify-center items-center mb-3 flex">
                        <img src="https://i1.wp.com/logos-download.com/wp-content/uploads/2021/01/PhonePe_Logo_full.png" alt="" className="h-10" />
                    </div>
...
export default PhonepePaymentTemplate;